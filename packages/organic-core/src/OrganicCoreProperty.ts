...
class OrganicCoreProperty<V, A = { [k: string]: any }> {
  ...
  protected _parent: OrganicCoreProperty<any>;
  ...
  public parent(): OrganicCoreProperty<any>;
  public parent(parent: OrganicCoreProperty<any>): this;
  public parent(...args: [OrganicCoreProperty<any>] | []) {
...
export default OrganicCoreProperty;
